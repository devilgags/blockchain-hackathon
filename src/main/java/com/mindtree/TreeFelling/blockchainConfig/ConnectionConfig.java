...
public class ConnectionConfig {
    private static final Log logger = LogFactory.getLog(ConnectionConfig.class);
...
//                    DEFAULT_CONFIG));
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.ca_location", "https://blockbusters-bts-blockchainhackathon.westus.cloudapp.azure.com:7054");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.peer_locations", "peer0.org1.example.com@grpcs://blockbusters-bts-blockchainhackathon.westus.cloudapp.azure.com:7051, peer1.org1.example.com@grpcs://blockbusters-bts-blockchainhackathon.westus.cloudapp.azure.com:8051");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.orderer_locations", "orderer.example.com@grpcs://blockbusters-bts-blockchainhackathon.westus.cloudapp.azure.com:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.eventhub_locations", "peer0.org1.example.com@grpcs://blockbusters-bts-blockchainhackathon.westus.cloudapp.azure.com:7053,peer1.org1.example.com@grpcs://blockbusters-bts-blockchainhackathon.westus.cloudapp.azure.com:8053");
            ...
            //defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.ca_location", "https://opcoe-hyperledger.southeastasia.cloudapp.azure.com:51002");
            //defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.peer_locations", "peer0.org2.example.com@grpcs://opcoe-hyperledger.southeastasia.cloudapp.azure.com:51008,peer1.org2.example.com@grpcs://opcoe-hyperledger.southeastasia.cloudapp.azure.com:51010");
            //defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.orderer_locations", "orderer.example.com@grpcs://opcoe-hyperledger.southeastasia.cloudapp.azure.com:51003");
            //defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg2.eventhub_locations", "peer0.org2.example.com@grpcs://opcoe-hyperledger.southeastasia.cloudapp.azure.com:51009, peer1.org2.example.com@grpcs://opcoe-hyperledger.southeastasia.cloudapp.azure.com:51011");
            ...
            for (Map.Entry<String, SampleOrg> org : sampleOrgs.entrySet()) {
                ...
                if (true) {
                    String cert = "artifacts/channel/crypto-config/peerOrganizations/DNAME/ca/ca.DNAME-cert.pem".replaceAll("DNAME", domainName);
    ...
    public String getTestChannelPath() {
    	...
    	//return "C:\\Users\\M1039224\\Documents\\Smart-Retail_Services\\crypto\\channel";
